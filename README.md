...
[![release](https://img.shields.io/github/v/release/Bespok3d/u1-camera-configs)](https://github.com/Bespok3d/u1-camera-configs/releases)
...
each `.b3`, cuts a release per plugin, assembles this repo's `index.json` sub-list as `U1 Camera
Configs`, and registers it in `Bespok3d/main-index` (`lists/<repo>.json`). Secrets:
